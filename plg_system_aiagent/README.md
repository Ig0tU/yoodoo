...
```
plg_system_aiagent/
├── aiagent.xml                        # Plugin manifest
├── aiagent.php                        # Main plugin entry point
├── language/                          # Translation files
│   └── en-GB/
│       ├── en-GB.plg_system_aiagent.ini
│       └── en-GB.plg_system_aiagent.sys.ini
...
## Installation
1. Zip the `plg_system_aiagent` folder.
2. Go to Joomla Administrator > Extensions > Manage > Install.
3. Upload the zip file.
4. Go to Extensions > Plugins and enable "System - AI Agent".
...
2. Click this icon to toggle the AI Agent overlay.
